...
export default function Login() {
  ...
  return (
    <LinearGradient colors={['#3EC0E9','#347589']} style={styles.container}>
      ...
      <Text style={[styles.heading, styles.textShadow]}>قم بتسجيل حساب جديد</Text>
      <TextInput value={email} onChangeText={setEmail} textContentType="emailAddress" style={[styles.textInput, styles.boxShadow]} placeholder="البريد الالكتروني" placeholderTextColor={'grey'}></TextInput>
      <TextInput value ={password} secureTextEntry={true} onChangeText={setPassword} textContentType="password" style={[styles.textInput, styles.boxShadow]} placeholder="كلمة السر" placeholderTextColor={'grey'}></TextInput>
      <TextInput value ={confirmPassword} secureTextEntry={true} onChangeText={setConfirmPassword} textContentType="password" style={[styles.textInput, styles.boxShadow]} placeholder="تأكيد كلمة السر" placeholderTextColor={'grey'}></TextInput>
